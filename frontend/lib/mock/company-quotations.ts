...
// ============================================================
const qtItems21: QuotationItem[] = [
  { id: '101', sortOrder: 1, productId: null, productCode: null, productName: '冷蔵庫 縦型6ドア', quantity: 1, unit: '台', unitPrice: 1680000, taxRate: 10, amount: 1680000, notes: '寸法: W1,790×D800×H1,950' },
  { id: '102', sortOrder: 2, productId: null, productCode: null, productName: '冷凍庫 縦型2ドア（左開仕様）', quantity: 1, unit: '台', unitPrice: 1137000, taxRate: 10, amount: 1137000, notes: '寸法: W610×D800×H1,950' },
  { id: '103', sortOrder: 3, productId: null, productCode: null, productName: 'スチームコンベクションオーブン（2/3サイズ6枚収納）', quantity: 1, unit: '台', unitPrice: 1946000, taxRate: 10, amount: 1946000, notes: '寸法: W655×D621×H595' },
