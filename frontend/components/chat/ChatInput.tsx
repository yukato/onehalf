      ...
      <div className="max-w-4xl mx-auto">
        <div className="flex gap-2">
          <textarea
            ...
            disabled={disabled}
            rows={1}
            className="flex-1 resize-none rounded-lg border border-gray-300 px-3 sm:px-4 py-2 text-base sm:text-sm focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary disabled:bg-gray-100 disabled:cursor-not-allowed"
          />
          <button
            type="submit"
