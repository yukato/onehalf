...
export default function AdminCompanyDocumentsPage() {
  ...
  }, [companySlug, loadDocuments, loadTags]);
  ...
  return (
    <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 ${activeTab === 'chat' ? 'h-full flex flex-col' : ''}`}>
      <ModuleHeader
        moduleName="書類管理"
      ...
      {activeTab === 'chat' ? (
        <DocumentChat companySlug={companySlug} apiType="admin" />
      ) : (
      <>
      {/* Search bar */}
      <SearchBox
