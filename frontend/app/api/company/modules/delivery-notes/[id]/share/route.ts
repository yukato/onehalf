...
import { updateDeliveryNoteStatus } from '@/lib/delivery-notes/queries';
...
export async function GET(
  ...
  try {
    ...
    const links = await listSharedLinks(payload.companySlug, 'delivery_note', id);
...
export async function POST(
  ...
  try {
    ...
    // Update delivery note status to 'issued'
    await updateDeliveryNoteStatus(payload.companySlug, id, 'issued');
